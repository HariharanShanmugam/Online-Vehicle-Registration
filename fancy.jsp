<%-- 
    Document   : fancy
    Created on : Mar 15, 2019, 11:56:14 PM
    Author     : Hariharan
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            <input type="submit" class="btn btn-outline-primary btn-block" value="FANCY NUMBER">
            <link rel="stylesheet" type="text/css" href="bootstrap.css">
        ...
        <form method="post" action="updateProfile.jsp">
            ...
            <input type="submit" class="btn btn-outline-danger btn-block" value="Update Profile">
        </form>
    </body>
</html>
